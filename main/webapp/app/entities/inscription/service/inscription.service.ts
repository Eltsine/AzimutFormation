...
export class InscriptionService {
  ...
  protected convertDateFromClient(inscription: IInscription): IInscription {
    return Object.assign({}, inscription, {
      dateInscription: inscription.dateInscription?.isValid() ? inscription.dateInscription.format(DATE_FORMAT) : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((inscription: IInscription) => {
        inscription.dateInscription = inscription.dateInscription ? dayjs(inscription.dateInscription) : undefined;
      });
    }
    return res;
  }
