...
class EtablissementResourceIT {
    ...
    public static Etablissement createEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().nom(DEFAULT_NOM).adresse(DEFAULT_ADRESSE);
    ...
    public static Etablissement createUpdatedEntity(EntityManager em) {
        Etablissement etablissement = new Etablissement().nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
        return etablissement;
    }
    ...
    void putNewEtablissement() throws Exception {
        ...
        updatedEtablissement.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
    ...
    void fullUpdateEtablissementWithPatch() throws Exception {
        ...
        partialUpdatedEtablissement.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE);
